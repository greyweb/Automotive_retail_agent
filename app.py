...
# Features: Synchronized filters, updated prompts, enhanced automotive expertise, no-results handler, BEAUTIFIED OUTPUT
...
def sql_executor_node(state: AgentState):
    ...
    try:
        ...
        required_cols = ['make', 'model', 'year', 'net_price', 'url', 'trim', 'msrp', 'condition', 'fuel_type', 'offers', 'finance_options', 'transmission']
